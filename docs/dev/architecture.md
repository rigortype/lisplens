...
diff <old> <new> [--json|--html] [--deep|--unit NAME]   structural diff: definition map (ADR-0047), drill a changed def (ADR-0048), or a self-contained visual page (--html, #42); exit 0 regardless of differences
